    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('book', 'تقارير المشتريات ', 'تقارير المشتريات  الجديدة');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            <label class="font-weight-bold" for="">من تاريخ  :&emsp;</label>
            <input type="date" class="form-control" id="start_date" onchange="showReport('purchase');">
            &emsp;
            <label class="font-weight-bold" for="">الى تاريخ  :&emsp;</label>
          ...
          <div class="col-md-12 text-center">
            <button class="btn btn-primary" onclick="printReport('Purchase');">طباعة التقرير </button>
          </div>
