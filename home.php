    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('home', 'اللوحة الرئيسية ', 'لوحة التحكم ');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_customer.php', ' الزبائن ', 'customers');
              createSection1('manage_supplier.php', 'الموردين', 'suppliers');
              createSection1('manage_medicine.php', 'الادوية ', 'medicines');
              createSection1('manage_medicine_stock.php?out_of_stock', 'Out of Stock', 'medicines_stock');
              createSection1('manage_medicine_stock.php?expired', 'Expied', 'medicines_stock');
              createSection1('manage_invoice.php', 'مجموع الفواتير ', 'invoices');
            ?>
          ...
          <div class="col col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding: 7px 0; margin-left: 15px;">
            <div class="todays-report">
              <div class="h5">التقرير اليومي </div>
              <table class="table table-bordered table-striped table-hover">
                <tbody>
                  ...
                  <tr>
                    ...
                    <th class="text-success">IQD. <?php echo $total; ?></th>
                  </tr>
                  <tr>
                    <?php
                      //echo $date;
                    ...
                    ?>
                    <th>مجموع الشراء </th>
                    <th class="text-danger">IQD. <?php echo $total; ?></th>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('address-card', 'new_invoice.php', 'انشاء فاتورة جديدة ');
            createSection2('handshake', 'add_customer.php', 'اضافة زبون جديد ');
            createSection2('shopping-bag', 'add_medicine.php', 'اضافة دواء جديد ');
            createSection2('group', 'add_supplier.php', 'اضافة مورد جديد ');
            createSection2('bar-chart', 'add_purchase.php', 'عمل فاتورة شراء ');
            createSection2('book', 'sales_report.php', 'تقارير المبيعات ');
            createSection2('book', 'purchase_report.php', 'تقارير المشتريات ');
          ?>
