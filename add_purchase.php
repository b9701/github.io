...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>عمل فاتورة شراء جديدة </title>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('bar-chart', 'اضافة فاتورة شراء ', 'اضافة فاتورة شراء جديدة ');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-4 form-group">
              <label class="font-weight-bold" for="suppliers_name">المورد  :</label>
              <input id="suppliers_name" type="text" class="form-control" placeholder="اسم المورد الثلاثي " name="suppliers_name" onkeyup="showSuggestions(this.value, 'supplier');">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="">رقم الفاتورة  :</label>
              <input type="number" class="form-control" placeholder="رقم الفاتورة " id="invoice_number" name="invoice_number" onblur="notNull(this.value, 'invoice_number_error'); checkInvoice(this.value, 'invoice_number_error');">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="paytype">طريقة الدفع  :</label>
              <select id="payment_type" name="paytype" class="form-control">
              	<option value="Cash Payment">دفع نقدي </option>
                <option value="Net Banking">الدفع عن طريق البنك </option>
                <option value="Payment Due">الدفع عبر الماسترد كارد</option>
              </select>
            </div>

            <div class="col col-md-2 form-group">
               <label class="font-weight-bold" for="invoice_date">التاريخ :</label>
          ...
          <div class="row col col-md-12">
            <div class="col col-md-2 font-weight-bold" style="color: green; cursor:pointer" onclick="document.getElementById('add_new_supplier_model').style.display = 'block';">
            	<i class="fa fa-plus"></i>&nbsp;اضافة مورد جديد 
            </div>
          </div>
          ...
          <div class="row col col-md-12 font-weight-bold">
            <div class="col col-md-2">اسم الدواء</div>
            <div class="col col-md-1">النوعية</div>
            <div class="col col-md-2">رقم الدفعة </div>
            <div class="col col-md-1">تاريخ الصلاحية  (mm/yy)</div>
            <div class="col col-md-1">الكمية</div>
            <div class="col col-md-1">MRP</div>
            <div class="col col-md-1">السعر </div>
            <div class="row col col-md-3">
              <div class="col col-md-7">المبلغ الكلي</div>
              <div class="col col-md-5">الحالة </div>
            </div>
          </div>
          <div class="col col-md-12">
            <hr class="col-md-12" style="padding: 0px; border-top: 2px solid  #02b6ff;">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">المجموع الكلي للدفع  :</label>
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary form-control" onclick="addPurchase();">انشاء فاتورة </button>
            </div>
            <div class="col col-md-5"></div>
          </div>
          <!-- closing button -->
